...
# %%
df_raw= pd.read_csv('../dados/lotacao_onibus_formatado.csv')
...
sum_=pd.read_csv('../dados/dashboard_subsidio_sppo/sumario_servico_dia_tipo.csv')
sum_['data']=pd.to_datetime(sum_['data'],format='%Y-%m-%d')

mb = pd.read_csv('../dados/matriz_linha_bairro_corrigida.csv') # colunas: 'bairro' e 'linha'
